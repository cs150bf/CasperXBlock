function parallel_fir(filter_coeffs)
...
xlsub3_c_to_ri_sub = xBlock(struct('source', str2func('c_to_ri'), 'name', 'c_to_ri'), ...
                        {8, 7}, ...
                        {xlsub3_f0_out2}, ...
...
xlsub3_c_to_ri1_sub = xBlock(struct('source', str2func('c_to_ri'), 'name', 'c_to_ri1'), ...
                         {8, 7}, ...
                         {xlsub3_f0pf1_out2}, ...
...
xlsub3_c_to_ri2_sub = xBlock(struct('source', str2func('c_to_ri'), 'name', 'c_to_ri2'), ...
                         {8, 7}, ...
                         {xlsub3_f1_out2}, ...
                         {xlsub3_c_to_ri2_out1, xlsub3_c_to_ri2_out2});

% block: half_band_xblock/Subsystem/parallel_fir/f0
xlsub3_f0_sub = xBlock(struct('source', str2func('dec_fir'), 'name', 'f0'), ...
                   {1, [1 2 3 4 5 6 7 8], 4, 'Truncate', 1, 2, 25, 24, 'on'}, ...
                   {xlsub3_In1, xlsub3_In2, xlsub3_In3}, ...
                   {xlsub3_sync_out, xlsub3_f0_out2});

% block: half_band_xblock/Subsystem/parallel_fir/f0pf1
xlsub3_f0pf1_sub = xBlock(struct('source', str2func('dec_fir'), 'name', 'f0pf1'), ...
                      {1, [1 2 3 4 5], 4, 'Truncate', 1, 2, 25, 24, 'on'}, ...
                      {xlsub3_In1, xlsub3_In2, xlsub3_In3}, ...
                      {[], xlsub3_f0pf1_out2});

% block: half_band_xblock/Subsystem/parallel_fir/f1
xlsub3_f1_sub = xBlock(struct('source', str2func('dec_fir'), 'name', 'f1'), ...
                   {1, [1 2 3 4 5 6 7 8], 4, 'Truncate', 1, 2, 25, 24, 'on'}, ...
                   {xlsub3_In1, xlsub3_In2, xlsub3_In3}, ...
                   {[], xlsub3_f1_out2});
