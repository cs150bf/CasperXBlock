...
if (n_inputs == 0)
    ...
    xlsub2_fft_biplex_sub = xBlock(struct('source', str2func('fft_biplex_init_xblock'), 'name', 'fft_biplex'), ...
                               {FFTSize-n_inputs, input_bit_width, coeff_bit_width, add_latency, mult_latency, bram_latency, conv_latency, quantization, overflow, arch, opt_target, coeffs_bit_limit, delays_bit_limit, specify_mult, mult_spec, hardcode_shifts, shift_schedule, dsp48_adders}, ...
...
% Add direct FFTs
if (n_inputs == 0)
    xlsub2_fft_biplex_out1.bind(xlsub2_sync_out);
    xlsub2_fft_biplex_out2.bind(out0);
    xlsub2_fft_biplex_out3.bind(out1);
    xlsub2_fft_biplex_out4.bind(xlsub2_of);
elseif (n_inputs == FFTSize)
