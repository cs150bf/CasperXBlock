...
%                                                                             %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function parallel_dec2_stage_nonrecursive_init_xblock(m,n_inputs,polyphase,add_latency,skip, n_bits, bin_pt,dec2_halfout)
...
if n_inputs==1 && strcmp(polyphase,'off') % only one input
    ...
    parallel_polynomial_decN_stage_init_xblock(m,2,n_inputs,polyphase,add_latency,skip, n_bits, bin_pt, 'off')
