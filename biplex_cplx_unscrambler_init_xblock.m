...
xlsub2_barrel_switcher1 = xBlock(struct('source', str2func('barrel_switcher_init_xblock'), 'name', 'barrel_switcher1'), ...
                                 {1}, ...
...
xlsub2_reorder_sub = xBlock(struct('source', str2func('reorder_init_xblock'), 'name', 'reorder'), ...
                        struct('map',[map,map+2^(FFTSize-1)], ...  % {[map,map+2^(FFTSize-1)], 1, 2, 0, 0, 'off'}, ...
...
xlsub2_reorder1_sub = xBlock(struct('source', str2func('reorder_init_xblock'), 'name', 'reorder1'), ...
                         struct('map',[map+2^(FFTSize-1),map], ...  %{[map+2^(FFTSize-1),map], 1, 2, 0, 0, 'off'}, ...
                                'bram_latency',bram_latency), ...
